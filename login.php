...
<div class="login-box">
    ...
    <form action="login_check.php" method="POST">
        ...
        <div class="user-box">
            <input type="password" id="password" name="password" class="invalid <?php echo isset($_SESSION['loginMessage']) ? 'error' : ''; ?>" required>
    ...
    <p style="color: #fff; text-align: center; margin-top: 50px;">
        <a href="forgot_password.php" style="color: #3633FF; text-decoration: none;">Forgot Password?</a>
    </p>
</div>
